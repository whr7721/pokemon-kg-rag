...
> **口径说明**：上表为成员二分支交付时的运行结果。整合进 `stage2-final` 后用最终代码重跑（见 `docs/retrieval.md` 第 5 节）为 `fulltext` 3/19 (15.8%)、`hybrid` 9/19 (47.4%)、`hybrid_graph` 14/19 (73.7%)，结论方向一致且更强；汇报请以 `docs/retrieval.md` 为准。
