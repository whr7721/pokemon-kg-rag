...
# 注意：不含“有哪些 / 特性”等宽泛词——否则“皮卡丘有哪些特性”会被误判为
# “问某特性的持有者”，进而跑错字纠错分支。只保留明确的持有者询问词。
HOLDER_WORDS = ("拥有", "具有", "带着", "携带", "谁有", "哪些宝可梦拥有", "谁会")
TYPES18 = ("一般", "格斗", "飞行", "毒", "地面", "岩石", "虫", "幽灵", "钢", "火", "水", "草", "电",
           "超能力", "冰", "龙", "恶", "妖精")
# 注意：不含裸“特性”——否则“皮卡丘有哪些特性”会被误判成配招策略题。
# 策略题均有“应对/适合/携带”等更准确的词兜底。
STRATEGY_WORDS = ("携带", "带什么", "适合", "应对", "面对", "对策", "推荐带")
